...
class questions_data_table extends WP_List_Table
{
    private $table_data;
    public $columns;
    ...
    private function get_table_data() {
        ...
        // $table = $wpdb->prefix . 'posts where post_type="msf_leads"' ;
    ...
    {
        $edit_url = "/wp-admin/admin.php?page=add_question&id= " . $item['id'];
